...
class TestFilterByDeepLevel:
    ...
    def test_get_characters_by_deep_level_npc_correctly_filters_characters(self, mocker):
        # Arrange
    ...
    def test_get_characters_by_deep_level_npc_no_matching_characters(self, mocker):
        # Arrange
        notion_service = NotionService()
        mock_characters = [
